...
/* harmony import */ var _employee_list_employee_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./employee-list/employee-list.component */ "./src/app/employee-list/employee-list.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_employee_list_employee_list_component__WEBPACK_IMPORTED_MODULE_1__["EmployeeListComponent"]], encapsulation: 2 });
...
/* harmony import */ var _employee_detail_view_employee_detail_view_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./employee-detail-view/employee-detail-view.component */ "./src/app/employee-detail-view/employee-detail-view.component.ts");
/* harmony import */ var _employee_list_table_view_employee_list_table_view_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./employee-list-table-view/employee-list-table-view.component */ "./src/app/employee-list-table-view/employee-list-table-view.component.ts");
...
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
        ...
        _employee_detail_view_employee_detail_view_component__WEBPACK_IMPORTED_MODULE_5__["EmployeeDetailComponent"],
        _employee_list_table_view_employee_list_table_view_component__WEBPACK_IMPORTED_MODULE_6__["EmployeeListTableViewComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"]] });
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _employee_list_employee_list_component__WEBPACK_IMPORTED_MODULE_7__["EmployeeListComponent"],
                    _employee_detail_view_employee_detail_view_component__WEBPACK_IMPORTED_MODULE_5__["EmployeeDetailComponent"],
                    _employee_list_table_view_employee_list_table_view_component__WEBPACK_IMPORTED_MODULE_6__["EmployeeListTableViewComponent"]
                ],
...
EmployeeDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EmployeeDetailComponent, selectors: [["employee-detail-view"]], inputs: { employee: "employee" }, decls: 16, vars: 5, consts: [[1, "card"], [1, "card-content"], [1, "card-title"]], template: function EmployeeDetailComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeListTableViewComponent", function() { return EmployeeListTableViewComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");



function EmployeeListTableViewComponent_tr_1_Template(rf, ctx) { if (rf & 1) {
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EmployeeListTableViewComponent_tr_1_Template_tr_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const employee_r1 = ctx.$implicit; const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.selectId.emit(employee_r1.id); });
...
class EmployeeListTableViewComponent {
    constructor() {
        this.list = [];
        this.selectedId = 0;
...
EmployeeListTableViewComponent.ɵfac = function EmployeeListTableViewComponent_Factory(t) { return new (t || EmployeeListTableViewComponent)(); };
EmployeeListTableViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EmployeeListTableViewComponent, selectors: [["employee-list-table-view"]], inputs: { list: "list", selectedId: "selectedId" }, outputs: { selectId: "selectId" }, decls: 2, vars: 1, consts: [[1, "bordered", "unselectable"], [3, "background-color", "click", 4, "ngFor", "ngForOf"], [3, "click"]], template: function EmployeeListTableViewComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EmployeeListTableViewComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/* harmony import */ var _employee_list_table_view_employee_list_table_view_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../employee-list-table-view/employee-list-table-view.component */ "./src/app/employee-list-table-view/employee-list-table-view.component.ts");
/* harmony import */ var _employee_detail_view_employee_detail_view_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../employee-detail-view/employee-detail-view.component */ "./src/app/employee-detail-view/employee-detail-view.component.ts");
...
class EmployeeListComponent {
    constructor(loader) {
        ...
        this.selectedId = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        // .valueChanges is missing the initial value; add it:
        const nameFilter = this.nameFilter.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(this.nameFilter.value));
        const sort = this.sort.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(this.sort.value));
        // List reacts to filter and sort changes
        this.filteredList = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])([
            nameFilter.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(250), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(x => loader.getList(x))),
            sort
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(([list, sortKey]) => Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__["sortBy"])(list, sortKey)));
        // Detail reacts to selected employee changes
        this.selectedEmployee = this.selectedId.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(id => loader.getDetails(id)));
    }
}
EmployeeListComponent.ɵfac = function EmployeeListComponent_Factory(t) { return new (t || EmployeeListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_employee_loader_service__WEBPACK_IMPORTED_MODULE_5__["EmployeeLoaderService"])); };
EmployeeListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EmployeeListComponent, selectors: [["employee-list"]], decls: 23, vars: 11, consts: [[1, "two-across"], [1, "card"], [1, "card-content"], [1, "card-title"], ["for", "nameFilter"], ["id", "nameFilter", "type", "text", "autocomplete", "off", 3, "formControl"], ["for", "sort"], ["id", "sort", "type", "text", 3, "formControl"], ["value", "last_name"], ["value", "hours_worked"], [3, "list", "selectedId", "selectId"], [3, "employee"]], template: function EmployeeListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectId", function EmployeeListComponent_Template_employee_list_table_view_selectId_18_listener($event) { return ctx.selectedId.next($event); });
...
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EmployeeListComponent, [{
    ...
    }], function () { return [{ type: _employee_loader_service__WEBPACK_IMPORTED_MODULE_5__["EmployeeLoaderService"] }]; }, null);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeLoaderService", function() { return EmployeeLoaderService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class EmployeeLoaderService {
    ...
    getList(searchText) {
        ...
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]()
            ...
            .set('_limit', '20');
        return this.http
            .get(apiUrl + '/employees', { params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["delay"])(randomDelay()));
    }
    getDetails(employeeId) {
        return this.http
            .get(`${apiUrl}/employees/${employeeId}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["delay"])(randomDelay()));
    }
}
EmployeeLoaderService.ɵfac = function EmployeeLoaderService_Factory(t) { return new (t || EmployeeLoaderService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); };
EmployeeLoaderService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: EmployeeLoaderService, factory: function (t) { return EmployeeLoaderService.ɵfac(t); }, providedIn: 'root' });
/*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](EmployeeLoaderService, [{
